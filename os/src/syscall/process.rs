...
use crate::{
    ...
    mm::{get_physical_address, translated_refmut, translated_str},
    task::{
...
pub fn sys_get_time(ts: *mut TimeVal, _tz: usize) -> isize {
    ...
    let token = current_user_token();
    let physical_address = get_physical_address(token, ts as usize);
...
pub fn sys_task_info(ti: *mut TaskInfo) -> isize {
    ...
    let token = current_user_token();
    let physical_address = get_physical_address(token, ti as usize);
